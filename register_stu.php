            ...
            <div id="container2">
                <div class="signup">  
                    ...
                    <form action="" method="post">
                        ...
                        <input type="text" id="department" name="department" placeholder="系別" required>
                        ...
                        <input type="tel" id="phone" name="phone" placeholder="手機號碼" required>
                    ...
                    <div class="go">
                    <h5 onclick="window.location.href='login_stu.php'">登入帳號</h5>
...
<?php
        ...
        $sql = "INSERT INTO `Member`(`fullname`, `department`, `gender`, `email`, `phone`, `password`) VALUES ('{$fullname}', '{$department}', '{$gender}', '{$email}', '{$phone}', '{$password}')";
        $result = $db->query($sql);
...
<style>
    *{
    ...
    h3, #fullname, #department, #gender, #email, #phone, #password, #comfirm_password{
        width: 200px;
        height: 30px;
        margin: 10px;
        color: #1b3a59;
