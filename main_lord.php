...
<body>
    <div class="navbar">
        <ul>
          ...
          <li style="float:right"><a class="active" onclick="window.location.href='.php'">已刊登</a></li>
          <li style="float:right"><a class="active" onclick="window.location.href='view_new.php'">我要刊登</a></li>
        </ul>
    </div>  
